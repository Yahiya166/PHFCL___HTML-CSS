  ...
  <main class="sponser">
   <header class="header">
    ...
    <section class="innerBanner">
      <div class="block__inner">
        <img src="./webImages/innerBanners/Sponser.png" alt="" />
        <h1>Sponsors</h1>
      </div>
    </section>
      ...
      <div class="block__inner">
        <div class="col1">
          <div class="inner_heading">
            <h3>EJAZ GROUP OF COMPANIES</h3>
          </div>
          <div class="inner_main">
            <p>
              EJAZ GROUP OF COMPANIES was established in 1950, for
              International trading of commodities like petroleum products,
              metals, edible oils and industrial raw material. In 1980, the
              group ventured into manufacturing and set up the first
              industrial unit under the bannerof ‘MianNazir Sons Industries
              (Pvt.) Ltd.
            </p>
            <p>
              The Group commissioned its textile division in 1987 and set up
              the first yarn-manufacturing unit under the banner of ‘Ejaz
              Textile Mills Ltd. In 1990, EGC decided to go for higher value
              addition in the area of yarn rather than follow run of the
              spinning units producing only weaving yarn. For this purpose, a
              new unit, based on state of the art technology was established
              in 1992 to produce top quality Carded and Combed Hosiery yarn
              under the banner of ‘Ejaz Spinning Mills Ltd’.
            </p>
            <p>
              Presently, comprising of 5 spinning units with latest European
              and Japanese technology, Ejaz Group boasts over 100,000 spindles
              as a market leader in knitting and woven yarns. The group has a
              long range of satisfied customers nationwide and abroad with its
              premium quality Pakistani cotton yarns, imported cotton carded
              and combed Medium Staple yarn, fine counts with ELS cotton,
              Compact, EliTwist, Siro, Stretched, CoreSpun and Slub Yarns.
            </p>
            <p>
              Under the leadership of Mr. Gohar Ejaz the group has grown to
              the stage where it proudly claims to be one of the biggest
              manufacturing companies in the textile sector of Pakistan, in a
              short span of time since its inception.
            </p>
            <p>
              He is a seasoned Industrialist and public figure, a qualified
              business graduate and one of the resourceful personality in
              Pakistan. He is the Chief Executive of “Ejaz Group Of Companies”
              comprising Ejaz Spinning Mills and Ejaz Textile Mills Limited
              and “Lake City Holdings (Pvt) Ltd” a resort / residential
              development project planned with around 18 holes, 214 Acres golf
              course.
            </p>
          </div>
        </div>
        <div class="col2">
          <div class="inner_heading">
            <h3>The Lake City Holdings (Private) Limited</h3>
          </div>
          <div class="inner_main">
            <p>
              The Lake City Holdings provides gated community and exclusive
              lifestyle to its residents. With the new development phase on
              the horizon, they are now pleased to announce to take their
              unmatched exclusivity a notch above by opening up doors of
              economic opportunities along the new and upcoming Commercial
              Boulevard, which is now ready for possession for their clients.
            </p>
            <p>
              They have a vision to add a five-star hotel, a community club,
              university and world class hospital.
            </p>
          </div>
        </div>
        <div class="col3">
          <div class="inner_heading">
            <h3>Age of Housing Units</h3>
          </div>
          <div class="inner_main">
            <p>
              Newly constructed housing units during last one year from the
              date of application. However, this requirement will not be
              applicable till March 31, 2023 under Tier 0, Tier 2 and Tier 3.
            </p>
          </div>
        </div>
      </div>
