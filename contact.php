...
<body>
  ...
  <header class="header">
                                ...
                                <li class="list__item"><a href="#">Product
                                    ...
                                    <div class="subMenu">
                                        <ul class="list">
                                            ...
                                            <li class="list__item"><a href="./eligibility.html">Eligibility Criteria</a>
                                            </li>
    ...
    <section class="innerBanner">
      <div class="block__inner">
        <img src="./webImages/innerBanners/5.png" alt="" />
...
?>
              ...
              <form action="" method="POST">
                <div class="inputGroup">
                  ...
                  <input type="text" placeholder="Enter Your Name" name="form[Name]"/>
                </div>
                <div class="inputGroup">
                  <div class="label">
                  ...
                  <input type="text" placeholder="Enter Your Phone Number" name="form[PhoneNumber]"/>
                </div>
                <div class="inputGroup">
                  <div class="label">
                  ...
                  <input type="text" placeholder="Enter Your Email" name="form[Email]"/>
                </div>
                <div class="inputGroup">
                  <div class="label">
                  ...
                  <input type="text" placeholder="Enter CNIC Number" name="form[CNIC]"/>
                </div>
                <div class="inputGroup">
                  <div class="label">
                  ...
                  <textarea rows="10" cols="20" placeholder="Enter Message" name="form[Message]"></textarea>
                </div>
                <div class="inputGroup">
