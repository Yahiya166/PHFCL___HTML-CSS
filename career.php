...
<body>
  <main class="contact">
    ...
    <section class="innerBanner">
      <div class="block__inner">
        <img src="./webImages/innerBanners/Career.png" alt="" />
        <h1>Career</h1>
      </div>
    </section>
     <section class="section1">
        <div class="section1__inner grid grid-col80">
      <div class="block__inner">
        <!--<div class="inner_heading">-->
        <!--  <h2>Careers</h2>-->
        <!--</div>-->
        <div class="loanCalculator block1x2">
        <div class="left aos-init aos-animate">
             <h3>Careers</h3>
...
if(isset($_POST) && !empty($_POST) ){ ?>
        ...
        // if($token->getToken("CV")){
                 ...
                 if(mail($to,$subject.' Career Form ',$msg, $headers)){
...
?>
          ...
          <form action="" class="form" method="POST">
            <div class="inputGroup">
                  ...
                  <input type="text" name="form[Name]" placeholder="Enter Your Name" />
                </div>
                <div class="inputGroup">
                  <div class="label">
                  ...
                  <input type="text" name="form[Adress]" placeholder="Enter Your Adress" />
                </div>
            <div class="inputGroup">
                  <div class="label">
                  ...
                  <input type="text" name="form[PhoneNumber]" placeholder="Enter Your Phone Number" /> 
                </div>
                <div class="inputGroup">
                  <div class="label">
            ...
            <div class="label">
              ...
              <textarea name="form[Message]" cols="30" rows="5" placeholder="Enter Your Message"></textarea>
            </div>
            <div class="inputGroup">
            <div class="label">
                    <label for="">Upload CV</label>
                  </div>
              <input type="file" name="form[CV"] />
            </div>
            <div class="inputGroup">
        ...
        <div class="right aos-init aos-animate" data-aos="fade-left">
              <h3>Locate us</h3>
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3619.874963141701!2d67.07951031489313!3d24.868119751075188!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3eb33ea5132b8c9d%3A0x7f6c75c250c00393!2sINTERACTIVE%20MEDIA!5e0!3m2!1sen!2s!4v1643092475092!5m2!1sen!2s"
    ...
    <section class="support grid grid-col80 block">
      <div class="block__inner">
        ...
        <p>
          We are devoted to solving your queries and concerns, quickly and to
          your satisfaction.
        </p>
                ...
                <div class="footer__top grid grid-col90 block">
                    <div class="block__inner block1x2">
                        ...
                        <div class="right" data-aos="fade-left">
                            <ul class="list list-inline">
                                <li class="list__item"><a href=""><i class="fab fa-facebook-f"></i></a></li>
                                <li class="list__item"><a href=""><i class="fab fa-twitter"></i></a></li>
                                <li class="list__item"><a href=""><i class="fab fa-linkedin-in"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="footer__bottom grid grid-col90 block">
                    <div class="block__inner">
                        <div class="footer__bottom--inner">
                            ...
                            <nav>
                                <ul class="list list-inline">
                                    <li class="list__item"><a href="">Feedback</a></li>
